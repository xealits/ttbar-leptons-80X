...
selection_specific = {'el': {'common': 'HLT_el && abs(leps_ID) == 11 && lep_matched_HLT[0] && met_corrected.pt() > 40 && nbjets > 0 && tau_IDlev[0] > 2 && tau_id[0]*lep_id[0] < 0 && lep_p4[0].pt() > 30 && fabs(lep_p4[0].eta()) < 2.4',
            ...
            'elmu_hltelmu': {'common': 'HLT_el && HLT_mu && leps_ID == -13*11 && lep_matched_HLT[0] && lep_matched_HLT[1] && lep_p4[0].pt() > 30 && fabs(lep_p4[0].eta()) < 2.4 && lep_p4[1].pt() > 30 && fabs(lep_p4[1].eta()) < 2.4',
               ...
               'taumutauh_antiMt_notau': {'common': 'HLT_mu && abs(leps_ID) == 13 && lep_matched_HLT[0] && nbjets == 0 && lep_p4[0].pt() > 30 && fabs(lep_p4[0].eta()) < 2.4 && sqrt(2*lep_p4[0].pt()*met_corrected.pt() * (1 - cos(lep_p4[0].phi() - met_corrected.phi()))) > 50 && (divector_mass(lep_p4[0].x(), lep_p4[0].y(), lep_p4[0].z(), lep_p4[0].t(), tau_p4[0].x(), tau_p4[0].y(), tau_p4[0].z(), tau_p4[0].t()) < 45 || divector_mass(lep_p4[0].x(), lep_p4[0].y(), lep_p4[0].z(), lep_p4[0].t(), tau_p4[0].x(), tau_p4[0].y(), tau_p4[0].z(), tau_p4[0].t()) > 85)',
                             'processes': [{'data': (data_files['mu'], [''], 0)}, tt_mu_processes, st_tW_mujets_processes, dy_mu_processes]},

               'taumutauh_antiMt_notau_nob': {'common': 'HLT_mu && abs(leps_ID) == 13 && lep_matched_HLT[0] && lep_p4[0].pt() > 30 && fabs(lep_p4[0].eta()) < 2.4 && sqrt(2*lep_p4[0].pt()*met_corrected.pt() * (1 - cos(lep_p4[0].phi() - met_corrected.phi()))) > 50 && (divector_mass(lep_p4[0].x(), lep_p4[0].y(), lep_p4[0].z(), lep_p4[0].t(), tau_p4[0].x(), tau_p4[0].y(), tau_p4[0].z(), tau_p4[0].t()) < 45 || divector_mass(lep_p4[0].x(), lep_p4[0].y(), lep_p4[0].z(), lep_p4[0].t(), tau_p4[0].x(), tau_p4[0].y(), tau_p4[0].z(), tau_p4[0].t()) > 85)',
                             'processes': [{'data': (data_files['mu'], [''], 0)}, tt_mu_processes, st_tW_mujets_processes, dy_mu_processes]}
                     }
