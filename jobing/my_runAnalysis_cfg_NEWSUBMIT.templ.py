...
runProcess = cms.PSet(
    ...
    jet_kino_cuts_pt    = cms.string("{jet_kino_cuts_pt}"),
    jet_kino_cuts_eta   = cms.string("{jet_kino_cuts_eta}"),
    tau_kino_cuts_pt    = cms.string("{tau_kino_cuts_pt}"),
    tau_kino_cuts_eta   = cms.string("{tau_kino_cuts_eta}"),
