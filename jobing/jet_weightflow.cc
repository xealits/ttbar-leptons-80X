...
cout << "dtag,ratio,jetmu_wjets,jet_wjets,mu_wjets,jetmu_qcd,jet_qcd,mu_qcd" << endl;

cout << dtag << "," << ratio << "," << weightflow->GetBinContent(11) << "," << weightflow->GetBinContent(12) << "," << weightflow->GetBinContent(13) << "," << weightflow->GetBinContent(21) << "," << weightflow->GetBinContent(22) << "," << weightflow->GetBinContent(23) << endl;
