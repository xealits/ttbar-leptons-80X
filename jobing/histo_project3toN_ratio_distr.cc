...
if (argc < 5)
	...
	std::cout << "Usage : " << argv[0] << " x|y|z distr1 distr2 rebin_factor x_axis_min_range x_axis_max_range filename" << std::endl;
	exit (0);
	}
...
TString distr1(argv[2]);
TString distr2(argv[3]);
...
h3->SetXTitle("ratio " + distr1 + " / " + distr2);
